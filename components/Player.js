...
function Player() {
    ...
    return (
        ...
        to-gray-900 text-white grid grid-cols-3 text-xs md:text-bas px-2 md:px-8">
            {/* Left */}
            ...
            <div className="flex items-center justify-evenly">
                ...
                <RewindIcon 
                onClick={() => spotifyApi.skipToPrevious()} //--The API call is not working
                className="button" />
                ...
                <FastForwardIcon
                    onClick={() => spotifyApi.skipToNext()} //--The API call is not working
                    className="button"
                />
